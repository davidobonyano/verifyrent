...
export const STATE_LGAS: Record<string, string[]> = {
    ...
    "Imo": ["Aboh Mbaise", "Ahiazu Mbaise", "Ehime Mbano", "Ezinihitte", "Ideato North", "Ideato South", "Ihitte/Uboma", "Ikeduru", "Isiala Mbano", "Isu", "Njaba", "Nwangele", "Nkwerre", "Obowo", "Oguta", "Ohaji/Egbema", "Okigwe", "Orlu", "Orsu", "Oru East", "Oru West", "Owerri Municipal", "Owerri North", "Owerri West", "Onuimo", "Ezinihitte Mbaise", "Ngor Okpala"],
    ...
    "Zamfara": ["Anka", "Bakura", "Birnin Magaji/Kiyaw", "Bukkuyum", "Bungudu", "Gummi", "Gusau", "Kaura Namoda", "Bakura", "Maradun", "Maru", "Shinkafi", "Talata Mafara", "Chafe", "Zurmi"]
};

export const PROPERTY_TYPES = [
    { label: "Single Room (Face-Me-I-Face-You)", value: "face-me-i-face-you" },
    { label: "Bedsitter (Self-Contain)", value: "self-contain" },
    { label: "Mini Flat (1 Bedroom)", value: "mini-flat" },
    { label: "2 Bedroom Flat", value: "2-bed-flat" },
    { label: "3 Bedroom Flat", value: "3-bed-flat" },
    { label: "4+ Bedroom Flat", value: "4-bed-flat" },
    { label: "Duplex / Terrace", value: "duplex" },
    { label: "Bungalow", value: "bungalow" },
    { label: "Shortlet / Service Apartment", value: "shortlet" }
];
...
export const DUMMY_PROPERTIES: Property[] = [
    {
        ...
        beds: 3,
        baths: 3,
        isDirectLandlord: true,
        landlord: "Olakunle Williams",
        agentId: "agt-1",
        images: [
            "https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?auto=format&fit=crop&w=800&q=80",
            "https://images.unsplash.com/photo-1512917774080-9991f1c4c750?auto=format&fit=crop&w=800&q=80",
            "https://images.unsplash.com/photo-1626379616459-b2ce1d9decbb?auto=format&fit=crop&w=800&q=80"
        ]
    },
    {
        id: "VR-2024-SURU-02",
        title: "Big Single Room space",
        price: "180,000",
        location: "Masha Road, Surulere",
        type: "Single Room (Face-Me-I-Face-You)",
        beds: 1,
        baths: 1,
    ...
    },
    {
        ...
        agentId: "agt-1",
        images: [
            "https://images.unsplash.com/photo-1512918766671-ad650b9b732d?auto=format&fit=crop&w=800&q=80",
    ...
    {
        id: "VR-2024-YABA-03",
        title: "Standard Bedsitter Apartment",
        price: "600,000",
        location: "Onike, Yaba, Lagos",
        type: "Bedsitter (Self-Contain)",
        beds: 1,
        baths: 1,
        isDirectLandlord: true,
        landlord: "Olakunle Williams",
        agentId: "agt-1",
        images: [
            "https://images.unsplash.com/photo-1536376074432-bf1340fa1690?auto=format&fit=crop&w=800&q=80",
