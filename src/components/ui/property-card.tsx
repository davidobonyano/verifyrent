                ...
                <div className="flex items-center justify-between pt-8 border-t border-vr-silver/10">
                    ...
                    <div className="flex gap-2">
                        ...
                        <button
                            onClick={(e) => {
                                e.preventDefault();
                                alert("Record Flagged. Legal team notified.");
                            }}
                            className="w-10 h-10 border border-vr-navy flex items-center justify-center text-vr-cream/20 hover:text-red-500 hover:border-red-500 transition-heavy"
                        >
